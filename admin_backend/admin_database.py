...
# ==================== 主项目 SQLite 数据库（只读） ====================
# 用于访问 Telegram Bot 用户数据（bindings 表等）
# 这个数据在 /root/royalbot/royalbot.db
sqlite_db_path = os.path.expanduser(settings.MAIN_DB_PATH)  # /app/data/royalbot.db in container
